...
void LED_Init(void)
{
 ...
 GPIO_InitStructure.GPIO_Pin = GPIO_Pin_5|GPIO_Pin_2;				 //LED0-->PB.5 端口配置
 ...
 GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2|GPIO_Pin_3;				 //LED0-->PB.5 端口配置
 GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出
 GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;		 //IO口速度为50MHz
 GPIO_Init(GPIOC, &GPIO_InitStructure);					 //根据设定参数初始化GPIOB.5
 GPIO_SetBits(GPIOC,GPIO_Pin_2);						 //PB.5 输出高
 GPIO_SetBits(GPIOC,GPIO_Pin_3);						 //PB.5 输出高
