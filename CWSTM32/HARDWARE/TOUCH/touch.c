...
{			    		   
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1;				 // PB1,PB2端口配置
 	...
 	GPIO_SetBits(GPIOB,GPIO_Pin_1);//上拉
  	...
  	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_9|GPIO_Pin_11;				 // PF9端口配置	推挽输出
 	GPIO_Init(GPIOF, &GPIO_InitStructure);
    GPIO_SetBits(GPIOF,GPIO_Pin_9|GPIO_Pin_11);//P9 上拉
